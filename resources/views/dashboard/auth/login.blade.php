                      ...
                      <div class="col-md-5 bg-white sign-in-page-data">
                          <div class="sign-in-from">
                            ...
                            @endif
                              ...
                              <form class="mt-4" method="POST" action="{{ route('dashboard.login.check') }}">
                                @csrf
                                  <div class="form-group">
                                      <label for="exampleInputEmail1">Email address</label>
                                      <input type="email" name="email" required class="form-control mb-0" id="exampleInputEmail1" placeholder="Enter email">
                                  </div>
                                  <div class="form-group">
                                  ...
                                  <div class="sign-info text-center">
                                      ...
                                      <span class="text-dark dark-color d-inline-block line-height-2">Don't have an account? <a href="{{ route('dashboard.register.index') }}">Sign up</a></span>
                                  </div>
                              </form>
                          </div>
                      </div>
