       ...
       <div class="row">
                ...
                <div class="iq-card">
                   <div class="iq-card-header d-flex justify-content-between">
                      <div class="iq-header-title">
                         <h4 class="card-title">Add New Admin Or Vendor</h4>
                      </div>
                   </div>
          ...
          <div class="col-lg-9">
                <div class="iq-card">
                   <div class="iq-card-header d-flex justify-content-between">
                      <div class="iq-header-title">
                         <h4 class="card-title">New Admin Or Vendor Information</h4>
                      </div>
                   </div>
                   @if ($errors->any())
                   ...
                   <div class="iq-card-body">
                      <div class="new-user-info">
                               ...
                               <div class="iq-card-body">
                                ...
                                @if (auth()->guard('admin')->user()->type === 'SUPER_ADMIN')
                                    <div class="custom-control custom-radio custom-control-inline">
                                        <input type="radio" value="SUPER_ADMIN" id="customRadio6" name="type" class="custom-control-input">
                                        <label class="custom-control-label" for="customRadio6"> Super Admin </label>
                                    </div>
                                @endif
                                <div class="custom-control custom-radio custom-control-inline">
                                   <input type="radio" value="ADMIN" id="customRadio7" name="type" class="custom-control-input">
                                   <label class="custom-control-label" for="customRadio7"> Admin </label>
                                </div>
                                <div class="custom-control custom-radio custom-control-inline">
                                   <input type="radio" value="VENDOR" id="customRadio8" name="type" class="custom-control-input" checked="">
                            ...
                            <button type="submit" class="btn btn-primary">Add New Admin OR Vendor</button>
                         </form>
                      </div>
                   </div>
                </div>
